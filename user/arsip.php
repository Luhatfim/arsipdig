        ...
        <div class="panel-body">
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    $no = 1;
                    $saya = $_SESSION['id'];
                    $arsip = mysqli_query($koneksi,"SELECT * FROM arsip,kategori,user WHERE arsip_petugas=user_id and arsip_kategori=kategori_id and arsip_petugas='$saya' ORDER BY arsip_id DESC");
